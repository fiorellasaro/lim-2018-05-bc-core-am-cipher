...
let nOffSet = 5;  //Variable que contendrá el Offset, el valor de N, el cual indica el usuario
...
let texto = 'hola'; 
while (texto.length !== charCounter){
numberAscii = texto.charCodeAt(indice);
